...
async function demonstrateRecipeExtraction() {
  try {
    ...
    console.log(`Title: ${(recipeData as any).title}`);
    console.log(`Description: ${(recipeData as any).description}`);
    console.log(`Ingredients: ${(recipeData as any).ingredients.length} items`);
    console.log(`Instructions: ${(recipeData as any).instructions.length} steps`);
    console.log(`Prep Time: ${(recipeData as any).prepTime}`);
    console.log(`Chill Time: ${(recipeData as any).chillTime}`);
    console.log(`Pan Size: ${(recipeData as any).panSize}`);
